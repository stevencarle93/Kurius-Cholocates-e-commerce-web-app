# Kurius chocolate e-commerce webpage
...
4. Migrate the migrations: `$ pipenv run reset_db` `$ pipenv run migrate` (skip if you have not made changes to the models on the `./src/api/models.py`)
